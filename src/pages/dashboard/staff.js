  ...
  return (
    <div className="min-h-screen flex flex-col bg-[url('/images/logo-full.webp')] bg-cover bg-center bg-no-repeat bg-fixed">
      <div className="min-h-screen flex flex-col backdrop-blur-sm bg-[rgba(5,0,30,0.8)]">
        <Head>
          <title>Staff Dashboard | Underground Chilling Room</title>
          <meta name="description" content="Staff dashboard for Underground Chilling Room" />
        </Head>
        ...
        <main className="flex-grow container mx-auto px-4 py-8">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold neon-text">Staff Dashboard</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              <div className="card mb-6 neon-border-blue">
                <h3 className="text-xl font-bold mb-4 neon-text-blue">Staff Overview</h3>
                <p>Staff tasks and assignments will be displayed here.</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="card neon-border-green">
                ...
                <div className="space-y-3">
                  ...
                  <Link href="/staff/inventory" className="btn-secondary w-full block text-center">
                    Check Inventory
                  </Link>
                </div>
              </div>
